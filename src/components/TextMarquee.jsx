...
const TextMarquee = () => {
  ...
  return (
    <div className="scroll bg-zinc-950 text-white flex justify-center items-center">
      <div className="text-marquee relative flex items-center overflow-hidden -mt-48">
        <div className="text-single leading-none whitespace-nowrap relative will-change-transform">
          <span className="text js-text inline-block mr-8 font-semibold text-[12rem]">Abdullah Al Akib -</span>
          <span className="text js-text inline-block mr-8 font-semibold text-[12rem]">Abdullah Al Akib -</span>
          <span className="text js-text inline-block mr-8 font-semibold text-[12rem]">Abdullah Al Akib -</span>
          <span className="text js-text inline-block mr-8 font-semibold text-[12rem]">Abdullah Al Akib -</span>
        </div>
